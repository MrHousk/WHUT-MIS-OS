...
for (i=0; i<20; i++)
{
    console.log(CSCAN(input, input.length, initial_position, initial_direction, i));
}
/*TEST FINISH*/

function CSCAN(input, list_size, initial_position, initial_direction, clickFrequency)
{
    var i, j, k;

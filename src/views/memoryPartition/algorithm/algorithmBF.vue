<template>
  ...
  <span class="hljs-comment">/*最佳适应算法
  ...
  缺点：造成了许多小的空闲区
  */</span>
  <span class="hljs-function"><span class="hljs-keyword">void</span> <span class="hljs-title">BestFit_new</span><span class="hljs-params">()</span>
  </span>{
      <span class="hljs-keyword">int</span> i, j, t, flag, request;
      <span class="hljs-built_in">printf</span>(<span class="hljs-string">"BestFit_new How Many MEMORY requir?\n"</span>);
      ...
      <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; MEMSIZE &amp;&amp; MemList[i].status != <span class="hljs-string">'e'</span>; i++)
      {
          <span class="hljs-keyword">if</span> (MemList[i].Size &gt;= request &amp;&amp; MemList[i].status == <span class="hljs-string">'f'</span>)
          {
              ...
              <span class="hljs-keyword">if</span> (MemList[i].Size &lt; t)
              {
                  t = MemList[i].Size;
                  j = i;
              }
      ...
      <span class="hljs-function"><span class="hljs-keyword">else</span> <span class="hljs-title">if</span> <span class="hljs-params">(MemList[i].Size - request &lt;= MINSIZE)</span> <span class="hljs-comment">//如果小于规定的最小差则将整个空间分配出去</span>
      </span>{
          MemList[i].status = <span class="hljs-string">'u'</span>;
      }
      <span class="hljs-keyword">else</span>
      {
          <span class="hljs-comment">//将i后的信息表元素后移</span>
          ...
          <span class="hljs-comment">//将i分成两部分，使用低地址部分</span>
  ...
  <span class="hljs-function"><span class="hljs-keyword">int</span> <span class="hljs-title">main</span><span class="hljs-params">()</span>
      ...
      BestFit_new(); <span class="hljs-comment">//最佳适应算法</span>

<template>
  ...
  <span class="hljs-function"><span class="hljs-keyword">void</span> <span class="hljs-title">fillTable</span><span class="hljs-params">(<span class="hljs-keyword">int</span> clickFrequency, <span class="hljs-keyword">int</span> task_num, <span class="hljs-keyword">float</span>* commit_time, <span class="hljs-keyword">float</span>* task_time, <span class="hljs-keyword">struct</span>  fcfsdata* fcfsObject, <span class="hljs-keyword">int</span>* operator_order)</span>
    ...
    <span class="hljs-keyword">float</span> temp = <span class="hljs-number">0</span>, total_operate_time = <span class="hljs-number">0</span>, time_one = <span class="hljs-number">0</span>, time_two = <span class="hljs-number">0</span>, min = <span class="hljs-number">0</span>;
    ...
    <span class="hljs-keyword">float</span>* temp_task_time = (<span class="hljs-keyword">float</span>*)<span class="hljs-built_in">malloc</span>(<span class="hljs-keyword">sizeof</span>(<span class="hljs-keyword">float</span>)*task_num);
    ...
    <span class="hljs-keyword">else</span>
    {
      <span class="hljs-keyword">if</span> (clickFrequency == <span class="hljs-number">1</span>)
      {
        ...
        <span class="hljs-keyword">for</span> (i = <span class="hljs-number">1</span>; i &lt; task_num; i++)
        {
          ...
          min = (<span class="hljs-keyword">float</span>)INT_MAX;
          <span class="hljs-keyword">for</span> (j = <span class="hljs-number">1</span>; j &lt; max_range; j++)
          {
            <span class="hljs-keyword">if</span> (temp_task_time[operate_order_temp[j]] == -<span class="hljs-number">1</span>)
              <span class="hljs-keyword">continue</span>;
            <span class="hljs-keyword">if</span> (min &gt; temp_task_time[operate_order_temp[j]])
            {
          ...
          <span class="hljs-keyword">if</span> (flag == <span class="hljs-number">0</span>)
          {
            ...
            temp_task_time[operator_order[i]] = -<span class="hljs-number">1</span>;
        ...
        <span class="hljs-comment">/*for (i = 0; i &lt; task_num; i++)
        {
    ...
    <span class="hljs-built_in">free</span>(operate_order_temp);
    <span class="hljs-built_in">free</span>(temp_task_time);
    <span class="hljs-keyword">return</span>;
  }</code></pre>
</template>

<template>
  ...
  <span class="hljs-function"><span class="hljs-keyword">void</span> <span class="hljs-title">CSCAN</span><span class="hljs-params">(<span class="hljs-keyword">int</span> *input, <span class="hljs-keyword">int</span> list_size, <span class="hljs-keyword">int</span> initial_position, <span class="hljs-keyword">int</span> initial_direction)</span></span>;
  ...
  <span class="hljs-function"><span class="hljs-keyword">int</span> <span class="hljs-title">main</span><span class="hljs-params">()</span>
      ...
      <span class="hljs-keyword">int</span> initial_direction = <span class="hljs-number">1</span>;
      ...
      CSCAN(input, <span class="hljs-keyword">sizeof</span>(input) / <span class="hljs-keyword">sizeof</span>(input[<span class="hljs-number">0</span>]), initial_position, initial_direction);
  ...
  <span class="hljs-comment">//int initial_direction; 磁头初始移动方向</span>
  <span class="hljs-comment">//------------------------------//</span>
  <span class="hljs-function"><span class="hljs-keyword">void</span> <span class="hljs-title">CSCAN</span><span class="hljs-params">(<span class="hljs-keyword">int</span> *input, <span class="hljs-keyword">int</span> list_size, <span class="hljs-keyword">int</span> initial_position, <span class="hljs-keyword">int</span> initial_direction)</span>
  </span>{
      <span class="hljs-keyword">int</span> i, j, k;
      <span class="hljs-keyword">int</span> position = initial_position; <span class="hljs-comment">//磁头初始位置</span>
      <span class="hljs-keyword">int</span> total_moving = <span class="hljs-number">0</span>; <span class="hljs-comment">//总移动距离</span>
          ...
          <span class="hljs-keyword">for</span> (j = <span class="hljs-number">0</span>; sort_list_cp[j] != -<span class="hljs-number">1</span>; j++)
          {
              <span class="hljs-keyword">if</span> (sort_list_cp[j] &gt;= position)
              {
                  <span class="hljs-keyword">if</span> (j &gt;= <span class="hljs-number">1</span>)
                  {
                      ...
                      <span class="hljs-keyword">if</span> ((initial_direction == <span class="hljs-number">1</span>) || (sort_list_cp[j] == position))
                      {
                  ...
                  <span class="hljs-keyword">else</span>
                  {
                      ...
                      <span class="hljs-keyword">if</span> (initial_direction == <span class="hljs-number">0</span>)
                      <span class="hljs-comment">//如果initial_direction = 0，则position跳转至sort_list_cp末尾继续向前扫描</span>
                      {
                          <span class="hljs-keyword">for</span> (k = <span class="hljs-number">0</span>; k &lt; list_size; k++)
                          {
                              <span class="hljs-keyword">if</span> ((sort_list_cp[k + <span class="hljs-number">1</span>] == -<span class="hljs-number">1</span>) || (k + <span class="hljs-number">1</span>) == list_size)
                                  <span class="hljs-keyword">break</span>;
                          }
                          <span class="hljs-built_in">printf</span>(<span class="hljs-string">"%2d# 被访问的下一个磁道号: %3d, 移动距离: %3d\n"</span>, i + <span class="hljs-number">1</span>, sort_list_cp[k], sort_list_cp[k] - position);
                          total_moving += <span class="hljs-built_in">abs</span>(sort_list_cp[k] - position);
                          position = sort_list_cp[k];
                          sort_list_cp[k] = -<span class="hljs-number">1</span>;
                          <span class="hljs-keyword">break</span>;
                      }
                      <span class="hljs-keyword">else</span>
                      {
              ...
              <span class="hljs-function"><span class="hljs-keyword">else</span> <span class="hljs-title">if</span> <span class="hljs-params">((sort_list_cp[j + 1] == -1)</span> || <span class="hljs-params">(j + 1)</span> </span>== list_size)
              {
                  ...
                  <span class="hljs-keyword">if</span> (initial_direction == <span class="hljs-number">1</span>)
                  <span class="hljs-comment">//如果initial_direction = 1，则position跳转至sort_list_cp首部继续向后扫描</span>
                  {
                      <span class="hljs-built_in">printf</span>(<span class="hljs-string">"%2d# 被访问的下一个磁道号: %3d, 移动距离: %3d\n"</span>, i + <span class="hljs-number">1</span>, sort_list_cp[<span class="hljs-number">0</span>], sort_list_cp[<span class="hljs-number">0</span>] - position);
                      total_moving += <span class="hljs-built_in">abs</span>(sort_list_cp[<span class="hljs-number">0</span>] - position);
                      position = sort_list_cp[<span class="hljs-number">0</span>];
                      <span class="hljs-keyword">for</span> (k = <span class="hljs-number">1</span>; k &lt; list_size; k++)
                      {
                          sort_list_cp[k - <span class="hljs-number">1</span>] = sort_list_cp[k];
                      }
                      sort_list_cp[list_size - <span class="hljs-number">1</span>] = -<span class="hljs-number">1</span>;
  ...
  <span class="hljs-comment">//对int型数组进行排序</span>
  ...
  <span class="hljs-comment">//拷贝两个指针（int型数组）</span>
